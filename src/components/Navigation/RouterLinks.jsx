...
const RouterLinks = () => {
  return (
    <>
      ...
      <li className="relative z-10 font-mono text-semibold text-xl sm:text-2xl md:text-base lg:text-xl xl:text-2xl  text-gray-900 after:absolute  after:-z-10 after:content-['→'] hover:text-emerald-800 dark:text-gray-100 dark:hover:text-indigo-200">
