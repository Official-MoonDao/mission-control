...
const OptionsContainer = ({ sectionOptions }) => {
  return (
    <div className="w-[335px] sm:w-[400px] xl:w-[335px] rounded-lg shadow-lg border-[0.5px] bg-white xl:bg-opacity-60 dark:bg-opacity-[0.04] dark:border-white dark:border-opacity-[0.38]">
      <ShieldContainer />
