...
{
  /*Finish adjusting SM size */
}
const Asset = ({ mooney, dollars }) => {
  return (
    <div className="mt-[18px] flex w-[279px] flex-col items-center rounded-lg border-[0.5px] border-white border-opacity-40 bg-white py-[15px] shadow-lg hover:scale-105 dark:bg-transparent dark:bg-opacity-[0.06] dark:shadow-sky-700 sm:w-[335px]">
